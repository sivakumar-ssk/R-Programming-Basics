...
#Many useful R function come in packages, 
...
#Once you have a package installed, you can make its contents available to use 
#in your current R session by running

library("<the package's name>")
#There are thousands of helpful R packages for you to use, 
#but navigating them all can be a challenge. 
#To help you out, We've used each of these, and found them to be outstanding -
#we've even written some of them. 
#These packages are also some of the top most downloaded R packages.
...
#Note: RStudio professional products come with professional drivers for some of the 
#most popular databases.

#RMySQL, RPostgresSQL, RSQLite 
#If you'd like to read in data from a database, these packages are a good place to start. 
#Choose the package that fits your type of database.

#XLConnect, xlsx 
#These packages help you read and write Micorsoft Excel files from R. 
#You can also just export your spreadsheets from Excel as .csv's.

#foreign - Want to read a SAS data set into R? Or an SPSS data set? 
#Foreign provides functions that help you load data files from other programs into R.

#haven - Enables R to read and write data from SAS, SPSS, and Stata.

#R can handle plain text files - no package required. 
#Just use the functions read.csv, read.table, and read.fwf. 
#If you have even more exotic data, consult the CRAN guide to data import and export.
...
#This collection includes all the packages in this section, 
#plus many more for data import, tidying, and visualization listed here.

#dplyr - Essential shortcuts for subsetting, summarizing, rearranging, 
#and joining together data sets. 
#dplyr is our go to package for fast data manipulation.

#tidyr - Tools for changing the layout of your data sets. 
#Use the gather and spread functions to convert your data into the tidy format, 
#the layout R likes best.
...
#Google Chart tools used to be called Gapminder, 
#the graphing software Hans Rosling made famous in his TED talk.

#To model data
#tidymodels - A collection of packages for modeling and machine learning 
#using tidyverse principles. 
#This collection includes rsample, parsnip, recipes, broom, and many other 
#general and specialized packages listed here.
...
#A perfect way to explore data and share findings with non-programmers.

#R Markdown - The perfect workflow for reproducible reporting. 
#Write R code in your markdown reports. 
#When you run render, R Markdown will replace the code with its results and 
#then export your report as an HTML, pdf, or MS Word document, or a HTML or pdf slideshow. 
#The result? Automated reporting. 
#R Markdown is integrated straight into RStudio.

#xtable - The xtable function takes an R object (like a data frame) and returns 
#the latex or HTML code you need to paste a pretty version of the 
#object into your documents. 
...
#quantmod - Tools for downloading financial data, 
#plotting common charts, and doing technical analysis.
...
#You can also read about the entire package development process online in 
